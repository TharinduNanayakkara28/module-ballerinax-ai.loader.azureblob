...
- **Text extraction:** direct decode for textual blobs; Apache Tika for PDFs (PDFBox) and Microsoft Office documents (Apache POI). Scanned (image-only) PDFs are detected and skipped/reported — OCR is not supported.
